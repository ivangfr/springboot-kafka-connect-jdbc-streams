...
public class ProductDetail extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductDetail\",\"namespace\":\"com.mycompany.commons.storeapp.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"string\"},{\"name\":\"unit\",\"type\":\"int\"}],\"connect.name\":\"com.mycompany.commons.storeapp.avro.ProductDetail\"}");
   ...
   */
  public static com.mycompany.commons.storeapp.avro.ProductDetail.Builder newBuilder() {
    return new com.mycompany.commons.storeapp.avro.ProductDetail.Builder();
  }
   ...
   * @return A new ProductDetail RecordBuilder
   */
  public static com.mycompany.commons.storeapp.avro.ProductDetail.Builder newBuilder(com.mycompany.commons.storeapp.avro.ProductDetail.Builder other) {
    if (other == null) {
      return new com.mycompany.commons.storeapp.avro.ProductDetail.Builder();
    } else {
      return new com.mycompany.commons.storeapp.avro.ProductDetail.Builder(other);
    }
  }
   ...
   * @return A new ProductDetail RecordBuilder
   */
  public static com.mycompany.commons.storeapp.avro.ProductDetail.Builder newBuilder(com.mycompany.commons.storeapp.avro.ProductDetail other) {
    if (other == null) {
      return new com.mycompany.commons.storeapp.avro.ProductDetail.Builder();
    } else {
      return new com.mycompany.commons.storeapp.avro.ProductDetail.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductDetail>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.mycompany.commons.storeapp.avro.ProductDetail.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.mycompany.commons.storeapp.avro.ProductDetail other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder setPrice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder setUnit(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.storeapp.avro.ProductDetail.Builder clearUnit() {
