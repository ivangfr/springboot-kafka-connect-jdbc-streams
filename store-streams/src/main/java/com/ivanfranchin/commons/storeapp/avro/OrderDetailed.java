...
public class OrderDetailed extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public int hashCode() {
    ...
    result = 31 * result + (created_at == null ? 0 : created_at.hashCode());
    result = 31 * result + (payment_type == null ? 0 : payment_type.hashCode());
    result = 31 * result + (status == null ? 0 : status.hashCode());
    result = 31 * result + Long.hashCode(customer_id);
    result = 31 * result + (customer_name == null ? 0 : customer_name.hashCode());
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof OrderDetailed)) {
      return false;
    }
    OrderDetailed other = (OrderDetailed) o;
    if (Utf8.compareSequences(this.id, other.id) != 0) {
      return false;
    }
    if (!java.util.Objects.equals(this.created_at, other.created_at)) {
      return false;
    }
    if (Utf8.compareSequences(this.payment_type, other.payment_type) != 0) {
      return false;
    }
    ...
    if (Utf8.compareSequences(this.customer_name, other.customer_name) != 0) {
      return false;
    }
