...
public class OrderProduct extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public int hashCode() {
    int result = 1;
    result = 31 * result + (order_id == null ? 0 : order_id.hashCode());
    result = 31 * result + Long.hashCode(product_id);
    result = 31 * result + Integer.hashCode(unit);
    return result;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (Utf8.compareSequences(this.order_id, other.order_id) != 0) {
      return false;
    }
