...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6222965840643536933L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.ivanfranchin.commons.storeapp.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"string\"}],\"connect.name\":\"com.ivanfranchin.commons.storeapp.avro.Product\"}");
   ...
   */
  public static com.ivanfranchin.commons.storeapp.avro.Product.Builder newBuilder() {
    return new com.ivanfranchin.commons.storeapp.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.ivanfranchin.commons.storeapp.avro.Product.Builder newBuilder(com.ivanfranchin.commons.storeapp.avro.Product.Builder other) {
    if (other == null) {
      return new com.ivanfranchin.commons.storeapp.avro.Product.Builder();
    } else {
      return new com.ivanfranchin.commons.storeapp.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.ivanfranchin.commons.storeapp.avro.Product.Builder newBuilder(com.ivanfranchin.commons.storeapp.avro.Product other) {
    if (other == null) {
      return new com.ivanfranchin.commons.storeapp.avro.Product.Builder();
    } else {
      return new com.ivanfranchin.commons.storeapp.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ivanfranchin.commons.storeapp.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ivanfranchin.commons.storeapp.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder setPrice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.commons.storeapp.avro.Product.Builder clearPrice() {
      price = null;
  ...
  public boolean equals(Object o) {
    ...
    if (Utf8.compareSequences(this.price, other.price) != 0) {
      return false;
    }
    return true;
  }
